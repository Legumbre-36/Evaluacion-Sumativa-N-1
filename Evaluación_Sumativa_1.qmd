...
2.  Instalar los siguientes paquetes si no están presentes. Para hacerlo, se debe crear un nuevo chunk en el documento (Ctrl + Alt + I) y copiar el siguiente código dentro de él: `install.packages(c("tidyverse", "ggplot2", "skimr", "haven", "rio"))`
...
A partir de esto, se seleccionaron las siguientes variables para el análisis:
